...
func (s *Store) UpdateRoute(id, orgID string, r *Route) (*Route, error) {
	...
	query := "UPDATE routes SET " + strings.Join(setClauses, ", ") + " WHERE id=$1 AND COALESCE(org_id::text, '00000000-0000-0000-0000-000000000000') = COALESCE($" + strconv.Itoa(orgIDArgIndex) + ", '00000000-0000-0000-0000-000000000000') RETURNING updated_at"
